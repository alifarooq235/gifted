...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "923216122087,923196586907", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
BOT_NAME: process.env.BOT_NAME || "FAROOQ A S", // Input Yours custom...(Maintain font for Flow)
